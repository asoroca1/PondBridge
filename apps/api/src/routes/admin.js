...
router.patch("/settings/branding", async (req, res) => {
  ...
  const next = resolveTheme({
    theme: {
      ...
      logoBackdrop: String(req.body?.logoBackdrop ?? (theme.logoBackdrop || "")).trim(),
      logoTreatment: String(req.body?.logoTreatment ?? (theme.logoTreatment || "")).trim(),
  ...
  const tenant = await TenantModel.update(req.tenant._id, {
    theme: {
      ...
      logoBackdrop: next.logoBackdrop,
      logoTreatment: next.logoTreatment,
