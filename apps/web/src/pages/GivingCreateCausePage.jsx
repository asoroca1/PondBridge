...
import { validateGivingStep } from "../lib/givingValidation.js";
...
export default function GivingCreateCausePage() {
  ...
  function next() {
    const message = validateGivingStep(form, step);
